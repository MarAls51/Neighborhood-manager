...
import { FlatList, StyleSheet , Dimensions,TouchableOpacity,Text} from "react-native";
...
export function Map({listings,navigation}){
  ...
  <FlatList
        ...
        extraData={listings}
        renderItem={({ item }) => (
          <Item title={item.title} logitude={item.longitude} latitude={item.latitude} description ={item.info}/>
        )}
