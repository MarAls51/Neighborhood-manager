...
<View style = {{alignItems: 'center',flex: 1,backgroundColor: "lightgreen"}}>
    ...
    <Text  iterationCount="infinite" style = {{padding: 20, fontStyle: 'italic',fontSize: 40, bottom: 55, fontWeight: 'bold', top: 20}}>Join Group</Text>
</View>
    <View style = {{flex: 3, backgroundColor: "#fff",alignItems: "center",borderTopLeftRadius: 10, borderTopRightRadius: 10, width: '100%'}}>
        <Animatable.Text animation = "shake" style = {{fontSize: 40,fontStyle:'italic',top: 230}}>
