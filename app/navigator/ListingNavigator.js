...
return((users.group === null) ?
  <Stack.Navigator>
    <Stack.Screen name = "noGroupListing" component = {noGroupListing} options = {{headerShown: false}} />
  </Stack.Navigator> 
  : 
  <Stack.Navigator>
 <Stack.Screen name = "listing" component = {listing} options = {{headerShown: false}} />
 <Stack.Screen name = "addNewListing" component = {addNewListing} options = {{headerShown: false}} />
  </Stack.Navigator>)}
}
